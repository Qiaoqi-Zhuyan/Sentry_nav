...
void Tracker::init(const Armors::SharedPtr & armors_msg)
{
  ...
  RCLCPP_DEBUG(rclcpp::get_logger("nav_armor_tracker"), "Init EKF!");
...
void Tracker::update(const Armors::SharedPtr & armors_msg)
{
  ...
  RCLCPP_DEBUG(rclcpp::get_logger("nav_armor_tracker"), "EKF predict");
  ...
  if (!armors_msg->armors.empty()) {
    ...
    if (min_position_diff < max_match_distance_ && yaw_diff < max_match_yaw_diff_) {
      ...
      RCLCPP_DEBUG(rclcpp::get_logger("nav_armor_tracker"), "EKF update");
      ...
      RCLCPP_WARN(rclcpp::get_logger("nav_armor_tracker"), "No matched armor found!");
    }
  }
...
void Tracker::handleArmorJump(const Armor & current_armor)
{
  ...
  RCLCPP_WARN(rclcpp::get_logger("nav_armor_tracker"), "Armor jump!");
  ...
  if ((current_p - infer_p).norm() > max_match_distance_) {
    ...
    RCLCPP_ERROR(rclcpp::get_logger("nav_armor_tracker"), "Reset State!");
  }
