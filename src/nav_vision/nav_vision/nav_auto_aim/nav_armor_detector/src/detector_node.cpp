...
#include "nav_armor_detector/armor.hpp"
#include "nav_armor_detector/detector_node.hpp"

namespace nav_auto_aim
{
ArmorDetectorNode::ArmorDetectorNode(const rclcpp::NodeOptions & options)
: Node("nav_armor_detector", options)
{
  ...
  // Armors Publisher
  armors_pub_ = this->create_publisher<nav_auto_aim_interfaces::msg::Armors>(
...
void ArmorDetectorNode::imageCallback(const sensor_msgs::msg::Image::ConstSharedPtr img_msg)
{
  ...
  if (pnp_solver_ != nullptr) {
    ...
    nav_auto_aim_interfaces::msg::Armor armor_msg;
...
std::unique_ptr<Detector> ArmorDetectorNode::initDetector()
{
  ...
  // Init classifier
  auto pkg_path = ament_index_cpp::get_package_share_directory("nav_armor_detector");
...
{
  lights_data_pub_ =
    this->create_publisher<nav_auto_aim_interfaces::msg::DebugLights>("/detector/debug_lights", 10);
  armors_data_pub_ =
    this->create_publisher<nav_auto_aim_interfaces::msg::DebugArmors>("/detector/debug_armors", 10);
...
RCLCPP_COMPONENTS_REGISTER_NODE(nav_auto_aim::ArmorDetectorNode)
